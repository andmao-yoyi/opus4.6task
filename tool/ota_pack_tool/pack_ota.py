...
def makeup_udp(isusb, type, firmwarefile, otafile, usbdevfile):
    ...
    if(isusb):
        ...
        usbdevicefile_obj = open(usbdevfile, 'wb+')
...
def help():
    ...
    print("第三个参数：原始固件路径")
    print("第四个参数：目标OTA路径")
    print("第五个参数：生成基于USB DEVICE的OTA包路径")
    print("")
    print("举例：")
    print("     python pack_ota.py 0 demo.bin update_sign.bin usb_device_update.upd")
    print("     python pack_ota.py 1 demo.bin update_sign.bin usb_device_update.upd")
    print("     python pack_ota.py 2 demo.bin update_sign.bin usb_device_update.upd")
    print("     python pack_ota.py 3 demo.bin update_sign.bin usb_device_update.upd")
    print("     python pack_ota.py 4 demo.bin update_sign.bin usb_device_update.upd")
    print("     python pack_ota.py 5 demo.bin update_sign.bin usb_device_update.upd")
...
def main(argv):
    ...
    makeup_udp(1, int(argv[1]), argv[2], argv[3], argv[4])
    print ("type:%d, pack %s -> %s Success!!!" %(int(argv[1]), argv[2],argv[3]))
    print ("USB device: %s make Success!!!" %(argv[4]))
